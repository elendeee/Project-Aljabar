...
if option == 'Home' or option == '':
    st.write("""# Penggunaan Nilai dan Vektor Eigen Untuk Menentukan Prioritas Faktor-Faktor Penentu Pemilihan dalam Pembelian Barang di E-Commerce""") #menampilkan halaman utama
